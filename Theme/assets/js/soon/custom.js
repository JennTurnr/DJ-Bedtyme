...
(function($) {
    ...
    **/
    var launch = new Date(2014, 06, 31, 11, 00); // var launch = new Date(2015, 06, 14, 11, 00);
    /**
    * The script
    **/
    var message = $('#message');
    ...
    function setDate(){
        ...
        if( launch < now ){
            ...
            setTimeout(setDate, 1000); //1000

            message.html('<b>REMY MAs OFFICIAL DJ ~ Countdown till #TheRulersBack</b>');
        }
    }
})(jQuery);
/******************************************************************************************************************************
